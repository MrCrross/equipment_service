    ...
    <x-slot name="header">
        <div class="mb-5">
            <div class="float-left">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('equipment.headers.types.create') }}</h2>
            </div>
            ...
            <form action="{{route('equipment.types.store')}}" method="POST">
                ...
                <div class="my-5 mx-5">
                    <div class="flex flex-col">
                        ...
                        <x-text-input type="text" name="name" :placeholder="__('equipment.fields.types.name')"></x-text-input>
                    </div>
                    <div class="mt-2">
